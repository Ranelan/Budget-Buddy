    ...
    >
      ...
      >
        ...
        <div
          ...
          onClick={() => navigate("/user-dashboard/recurring")}
        >
          <div style={{ color: "#fff", fontWeight: "bold", fontSize: "1.1em", marginBottom: "0.5em" }}>
            Recurring Transactions
          </div>
        ...
        <div
          ...
          onClick={() => navigate("/user-dashboard/category")}
        >
          <div style={{ color: "#fff", fontWeight: "bold", fontSize: "1.1em", marginBottom: "0.5em" }}>
            Category
          </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <Link className={`dashboard-sidebar-link${location.pathname.endsWith("/budget") ? " active" : ""}`} to="budget">
            Budget
          </Link>
          <Link className={`dashboard-sidebar-link${location.pathname.endsWith("/goal") ? " active" : ""}`} to="goal">
            Goals
          </Link>
          ...
          <Link className={`dashboard-sidebar-link${location.pathname.endsWith("/profile") ? " active" : ""}`} to="profile">
            Profile
          </Link>
        </aside>
